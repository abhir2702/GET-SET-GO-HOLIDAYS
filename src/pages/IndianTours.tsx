...
import { getIndianTours } from '@/data/tours';
...
const IndianTours = () => {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <div className="relative h-[60vh] md:h-[80vh] bg-cover bg-center" style={{ backgroundImage: `url(${indianTourHero})` }}>
        <div className="absolute inset-0 bg-black/40"></div>
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center">Indian Tours</h1>
          <p className="text-xl max-w-2xl text-center">Explore the diverse landscapes and rich cultural heritage across India</p>
        </div>
      </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8">
            {searchTerm ? `Search Results (${filteredTours.length})` : 'All Indian Tours'}
          </h2>
